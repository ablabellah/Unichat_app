...
<div class="offcanvas offcanvas-start" tabindex="-1" id="robot_sidebar" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasExampleLabel">UniChat Assistant</h5>
    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  <div class="offcanvas-body" >
  <!DOCTYPE html>
...
<head>
    ...
    <title>UniBot for UniChat</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="form-group">
        <input type="text" id="query" name="q" class="form-control" placeholder="Enter your message">
        ...
        $('#myForm').submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#query').val(''); // Réinitialise la valeur de l'input
