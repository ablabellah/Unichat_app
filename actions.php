...
if(isset($_GET['addpost'])){
   $response = validatePostMedia($_FILES['post_img']);
...
if (isset($_POST['delete_user'])) {
    // Assuming you have the $userId available in the $_POST['user_id'] variable

    if (deleteUser()) {
        // User deleted successfully, redirect to login.php
...
/*if (isset($_POST['delete_user'])) {
    ...
    if (deleteUser()) {
        // User deleted successfully, redirect to deleted.php
